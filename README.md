...
国内券商采购的第三方量化交易软件主要有掘金量化、QMT及PTrade，研发实力强的券商也推出自研量化交易软件。考虑到个人投资者参与量化交易的门槛，目前JingniFlow优先选择适配下列三款量化交易软件。
...
**学习目标**：理解JingniFlow的设计理念、整体结构以及如何通过配置适应不同券商量化交易软件的策略环境。
